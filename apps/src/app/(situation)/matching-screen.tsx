...
import { questionSets } from '@/data/mini-game/matching'
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-row items-center p-4">
        ...
        <Text className="flex-1 text-center text-lg font-semibold mr-10">Ghép nối</Text>
      </View>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="px-4">
        <View className="flex-1">
          <Text className="text-center mb-10 mt-5">
            Ghép cột A (Thuật ngữ) với cột B (Định nghĩa)
          </Text>
          <View className="flex-row justify-between mb-6">
            <View className="flex-1 mr-2">
              <Text className="font-bold mb-2">Cột A - Thuật ngữ</Text>
        ...
        {showResult ? (
          <View>
            <View className="bg-[#F8F9FA] rounded-lg p-6 mb-6 border border-gray-200">
              ...
              <Text className="text-center text-3xl font-bold text-[#734DBE] mb-2">{score}%</Text>
            ...
            <TouchableOpacity
              className="bg-[#734DBE] py-4 items-center rounded-full mb-8"
          ...
          <TouchableOpacity
            className="bg-[#734DBE] rounded-full py-4 items-center mt-2 mb-8"
            disabled={!allMatched}
            onPress={() => {
